...
class PatitoVisitor(ParseTreeVisitor):
    ...
    # Visit a parse tree produced by PatitoParser#statement_p.
    ...
    # Visit a parse tree produced by PatitoParser#print_cfg.
    ...
    # Visit a parse tree produced by PatitoParser#return_cfg.
    def visitReturn_cfg(self, ctx:PatitoParser.Return_cfgContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by PatitoParser#return_p.
